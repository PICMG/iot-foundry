...
| **Socket** | A software interface that enables communication between applications. In Linux, sockets allow user-space programs to send and receive data using protocols like TCP, UDP, or MCTP. |
