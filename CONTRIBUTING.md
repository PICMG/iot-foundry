...
In addition, we require tat all contributors also sign the [Contributor License Agreement](IoTFoundry_Contributor_License_Agreement.pdf). Please submit the completed agreement to the community moderator (doug@picmg.org)
